...
module.exports = {
  ...
  const embed = new MessageEmbed()
    ...
    const done = new MessageEmbed()
       .setDescription(`<a:yes:934051517986656256>  | Your suggestion is Submitted here, <#${channel}>\n\nNote: You agreed to get a DM on a reply over your Suggestion!`)
       .setColor("00FFFF")
    ...
    await msgEmbed.react('<:blob_yes:932325521382080523>')
    await msgEmbed.react('<:blob_no:932318175222186014> ')
  }
}